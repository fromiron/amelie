...
<body>
 ...
 <div class="userInsertCompletion_contents">
  <div class="userInsertCompletion__wrapper">
   ...
   %>
   <div class="userInsertCompletion_result__title">会員登録を完了しました。</div>
   <div class="userInsertCompletion_result__text"><%=sessionName%>様のIDは
   </div>
   <div class="userInsertCompletion_result__id"><%=sessionId%></div>
   <div class="userInsertCompletion_result__text">でございます。</div>
   <%
       } else {
   %>
   <div class="userInsertCompletion_result__title">会員登録を失敗しました。</div>
   <div class="userInsertCompletion_result__text">最初からやり直してください。</div>
   <%
       }
   %>
  </div>
