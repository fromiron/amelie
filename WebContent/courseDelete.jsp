...
<body>
 ...
 <%
     ...
     try {
         menuID = Integer.parseInt((String) request.getParameter("courseId"));
        } catch (Exception e) {
     }
  ...
  <div class="menu_panel">
   <form method="post" action="CourseOperationSvl">
    <table class="readonly">
     <tr>
      <th colspan="2" class="menu_panel__title delete">コースの削除</th>
     </tr>
     <tr>
      <th class="menu_panel__sub_title">コース名</th>
      <td><input type="text" name="courseName" class="menu_panel__input readonly" value="<%=menu.getCourseName()%>" readonly /></td>
     </tr>
     <tr>
     ...
     <tr>
      ...
      <td>
       ...
       %> <input type="radio" name="orderFlg" value="1" checked="checked" disabled>可</input> <input type="radio" name="orderFlg" value="0" disabled>不可</input> <%
     } else {
 %> <input type="radio" name="orderFlg" value="1" disabled>可</input> <input type="radio" name="orderFlg" value="0" checked="checked" disabled>不可</input> <%
     }
 %>
     ...
     <tr>
      ...
      <td class="menu_panel__input comment readonly"><textarea name="detail" rows="5" cols="30" class="textAreaReadOnly" readonly><%=menu.getDetail()%></textarea></td>
     </tr>
     ...
     <tr>
      <td colspan="2"><input type="hidden" name="courseId" value="<%=menu.getCourseId()%>"></input> <input type="hidden" name="mode" value="23"> </input> <input type="submit" value="コースを削除"
       class="big_button" /></td>
     </tr>
