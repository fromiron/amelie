 ...
 <div class="menu_panel_container">
  ...
  <div class="menu_panel">
   <form method="post" action="CourseOperationSvl">
    <table>
     <tr>
      <th colspan="2" class="menu_panel__title change">コースの登録</th>
     </tr>
     <tr>
      <th class="menu_panel__sub_title">コース名</th>
      <td><input type="text" name="courseName"
       class="menu_panel__input" required ></input></td>
     </tr>
     <tr>
   ...
   <input type="radio" name="orderFlg" value="0" >不可</input>
    ...
    <tr>
     ...
     <tr>
      ...
      <input type="hidden" name="mode" value="21"></input>
      <input type="submit" value="コースを登録"
       class="big_button" /></td>
     </tr>
