...
<script src="./public/js/userUpdate.js" defer="defer"></script>
...
<body>
 ...
 <div class="join_contents user_update">
  <div class="join_form">
    ...
    <div class="join_form__innerWrapper">
     <div class="join_input_wrapper">
      <div class="join_sub_title">
       ...
       <div class="join_input_text_wrapper">
        <input class="join__text readonly" id="userId" type="text" name="usrId" value="<%=session.getAttribute("usrId")%>" readonly />
       </div>
      </div>
      <div class="join_sub_title">
       <div class="join_sub_title__title">USER Pass</div>
       <div class="join_input_text_wrapper">
        <input class="join__text" id="password" type="password" name="password" placeholder="パスワードを入力してください。" required />
       </div>
      </div>
      <div class="join_sub_title">
       <div class="join_sub_title__title">USER Pass - Repeat</div>
       <div class="join_input_text_wrapper">
        <input class="join__text" id="password2" type="password" name="password2" placeholder="パスワードを再度確認してください。" required />
       </div>
      </div>
      <div class="join_sub_title">
       <div class="join_sub_title__title">Name</div>
       <div class="join_input_text_wrapper">
        <input class="join__text readonly" id="userName" type="text" name="usrName" value="<%=session.getAttribute("usrName")%>" readonly />
       </div>
      </div>
      <div class="join_sub_title">
       <div class="join_sub_title__title">Address</div>
       <div class="join_input_text_wrapper">
        <input class="join__text readonly" id="address" type="text" name="address" value="<%=session.getAttribute("address")%>" placeholder="住所を入力してください。" readonly />
       </div>
      </div>
      <div class="join_sub_title">
       <div class="join_sub_title__title">e-Mail</div>
       <div class="join_input_text_wrapper">
        <input class="join__text readonly" id="mail" type="text" name="mail" value="<%=session.getAttribute("mail")%>" placeholder="メールを入力してください。" readonly />
       </div>
      </div>
      <div class="join_sub_title">
       <div class="join_sub_title__title">TEL</div>
       <div class="join_input_text_wrapper">
        <input class="join__text readonly" id="tel" type="text" name="phone" value="<%=session.getAttribute("phone")%>" placeholder="ご連絡先を入力してください。" readonly />
       </div>
      </div>
     </div>
     <div class="join_submit_wrapper">
      <input type="hidden" name="mode" value="13" /> <input class="join__submit" type="button" value="退会" />
