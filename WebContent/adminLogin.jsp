...
<div class="login_contents">
        ...
        <div class="login_form admin">
            <form method="post" action="AdminLoginSvl">
                ...
                <div class="login_form__innerWrapper">
                    <div class="login_input_wrapper">
                        <div class="login_sub_title">
                            <div class="login_sub_title__title">ADMIN ID</div>
                            <div class="login_input_text_wrapper"><input class="login__text" type="text" name="admName" placeholder="ADMIN IDを入力してください。" required /></div>
                        </div>
                        <div class="login_sub_title">
                            <div class="login_sub_title__title">ADMIN Pass</div>
