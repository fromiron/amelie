...
<body>
 ...
 <%
     ...
     ArrayList<Reserve> rsv = Reserve.getAllReserve();
 %>
  ...
  <div class="menuMaintenance_wrapper">
   <div class="menu_show_table">
    <table style="border-collapse: collapse;" border="1">
     <tr>
      <td colspan="7" class="menu_show_table__title top"><h2>予約リスト</h2></td>
      ...
      <tr class="menu_show_table__row">
       <td class="menu_show_table__cell"><%=r.getRsv_date().replace(":00.0", "")%></td>
       <td class="menu_show_table__cell"><%=r.getUsrName()%></td>
       <td class="menu_show_table__cell"><%=r.getUsrId()%></td>
