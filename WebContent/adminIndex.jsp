...
<div class="user_index_contents">
    <div class="user_index">
        <div class="user_index__user_name"><%=sessionAdmName%>様の管理ページ
        </div>
        <div class="user_index__list">
            <form method="post" action="MenuMaintenanceSvl">
                <input type="hidden" name="typeID" value="200"/> <input
                    type="submit" class="user_index__list value" value="メニューメンテナンス"/>
            </form>
        </div>
        ...
        <div class="user_index__list">
            <form method="post" action="MenuMaintenanceSvl">
                <input type="hidden" name="typeID" value="100"/> <input
                    type="submit" class="user_index__list value" value="コースメンテナンス"/>
            </form>
        </div>


        <div class="user_index__list">
            <form method="post" action="AdminReserveListSvl">
                <input type="submit" class="user_index__list value" value="予約リスト確認"/>
            </form>
        </div>


        <div class="user_index__list">
            <form method="post" action="AdminUserListSvl">
                <input type="submit" class="user_index__list value" value="お客様リスト確認"/>
            </form>
        </div>
