...
<head>
    ...
    <script type="text/javascript" defer="defer">
        window.onload = function () {
            const typeId = document.querySelector(".dbMenuTypeId").innerHTML.trim();
            const typeName = document.querySelector(".dbMenuTypeName").innerHTML.trim();
            let menuPriority = document.querySelector(".dbMenuPriority").innerHTML.trim();
            menuPriority = menuPriority - 1;


            const selectOption = document.querySelector("#selectOption");
            const optionList = selectOption.children;
            ...
            selectPriority.options[menuPriority].selected = true;
...
<% int menuID = 1;
    ...
    try {
        menuID = Integer.parseInt((String) request.getAttribute("menuID"));
        typeID = Integer.parseInt((String) request.getAttribute("typeID"));
    } catch (Exception e) {
    }
...
<div class="dbMenuTypeId" style="display: none"><%=menu.getTypeID()%>
</div>
<div class="dbMenuTypeName" style="display: none"><%=menu.getTypeName()%>
</div>
<div class="dbMenuPriority" style="display: none"><%=menu.getPriority()%>
</div>
<div class="dbMenuMenuId" style="display: none"><%=menu.getMenuID()%>
</div>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="radio" name="orderFlg" value="1" checked="checked">可</input>
                        <input type="radio" name="orderFlg" value="0">不可</input>
                        <%
                        } else {
                        %>

                        <input type="radio" name="orderFlg" value="1">可</input>
                        <input type="radio" name="orderFlg" value="0" checked="checked">不可</input>
                ...
                <tr>
                    ...
                    <td><select id="selectOption" name="typeID" required>
                ...
                <tr>
                    ...
                    <td class="menu_panel__input comment"><textarea name="detail"
                                                                    rows="10" cols="30"><%=menu.getDetail()%></textarea>
                    </td>
                </tr>
                ...
                <tr>
                    <td colspan="2">
                        <input type="hidden" name="menuID" value="<%=menu.getMenuID()%>"></input>
                        <input type="hidden" name="mode" value="12"></input>
                        <input type="submit" value="メニューを変更"
                               class="big_button"/></td>
                </tr>
